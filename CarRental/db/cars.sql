...
INSERT INTO `client` (`client_id`, `fname`, `email`, `id_no`, `phone`, `location`, `gender`, `car_id`, `status`, `esewa`) VALUES
(2, 'Sarthak luitel', 'srkth2000@gmail.com', 30073147, 9843806283, 'kalimati', 'Male', 1, 'Approved', 'GTD45H7H6'),
(3, 'bhupendra khadka', 'bhupendra6969@gmail.com', 27695131, 9841366115, 'balkhu', 'Male', 2, 'Approved', 'DJFL870FDK9'),
(4, 'sita shrestha', 'sita@gmail.com', 1234567, 984136555, 'teku', 'Female', 2, 'Approved', 'HJHK678X');
